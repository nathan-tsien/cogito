...
**Called by**: H01 Turn Driver, on entry. The returned value is **cached for
...
2. **Never calls any other Brain component.** The dependency arrow goes one way: H10 is called by H01, and its output is read by H04/H05/H09. H10 does not know they exist.
