...
- [0013](./0013-credential-isolation.md) — Credential isolation → **Credential Broker** seam (tool/MCP auth out of core scope; Brain never touches credentials; needs its own design pass) — **Proposed (draft 2026-06-03, needs more design; v0.4)**
